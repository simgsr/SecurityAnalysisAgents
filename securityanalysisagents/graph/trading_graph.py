# SecurityAnalysisAgents/graph/trading_graph.py
...
from securityanalysisagents.agents.utils.agent_utils import (
...
from securityanalysisagents.dataflows.utils import safe_ticker_component
...
class SecurityAnalysisAgentsGraph:
    """Main class that orchestrates the security analysis agents framework."""
    ...
    def __init__(
        ...
        """Initialize the security analysis agents graph and components.
    ...
    def _get_provider_kwargs(self) -> dict[str, Any]:
        ...
        # float() here so a value coming from a SECURITYANALYSISAGENTS_TEMPERATURE env
    ...
    def propagate(self, company_name, trade_date, asset_type: str = "stock"):
        """Run the security analysis agents graph for a company on a specific date.
    ...
    def _log_state(self, trade_date, final_state):
        ...
        directory = Path(self.config["results_dir"]) / safe_ticker / "SecurityAnalysisAgentsStrategy_logs"
