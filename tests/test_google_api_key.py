...
from securityanalysisagents.llm_clients.google_client import GoogleClient
...
class TestGoogleApiKeyStandardization(unittest.TestCase):
    ...
    @patch("securityanalysisagents.llm_clients.google_client.NormalizedChatGoogleGenerativeAI")
