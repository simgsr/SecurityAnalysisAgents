...
from securityanalysisagents.agents.analysts.sentiment_analyst import create_sentiment_analyst
from securityanalysisagents.agents.managers.research_manager import create_research_manager
from securityanalysisagents.agents.schemas import (
    PortfolioDecision,
    PortfolioRating,
    ResearchPlan,
    SentimentBand,
...
def test_invoke_structured_falls_back_when_result_is_none():
    ...
    from securityanalysisagents.agents.utils.structured import invoke_structured_or_freetext
