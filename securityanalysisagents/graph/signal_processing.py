...
header (see :func:`securityanalysisagents.agents.schemas.render_pm_decision`).  The
deterministic heuristic in :mod:`securityanalysisagents.agents.utils.rating` is more
...
from securityanalysisagents.agents.utils.rating import parse_rating
