...
header.  The deterministic heuristic in ``securityanalysisagents.agents.utils.rating``
...
from securityanalysisagents.agents.utils.rating import RATINGS_5_TIER, parse_rating
